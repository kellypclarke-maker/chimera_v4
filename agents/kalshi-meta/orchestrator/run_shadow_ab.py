...
def main() -> int:
    ...
    parser.add_argument("--maker-mode", action="store_true", help="Pass --is-maker to both control and experiment strategies.")
    ...
    print(f"[AB] execution_mode={'maker' if maker_mode else 'taker'}")
